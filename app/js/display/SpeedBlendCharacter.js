 ...
 */
  ...
  //==============================================================================
  var SpeedBlendCharacter = function () {
    ...
    this.load = function( url, loadedCB ) {
      ...
      loader.load( url, function( geometry, materials ) {
        ...
        for ( var i = 0; i < geometry.animations.length; ++i ) {
          ...
          self.animations[ animName ] = new THREE.Animation( self, geometry.animations[ i ] );

        }

        self.idle = self.animations[ 'metarigAction' ];
        console.log("self.idle = "+self.idle);
        console.dir(self.idle);
        self.walk = self.animations[ 'metarigAction' ];
        self.run = self.animations[ 'metarigAction' ];
  ...
  //==============================================================================
  SpeedBlendCharacter.prototype = Object.create( THREE.SkinnedMesh.prototype );

  SpeedBlendCharacter.prototype.getForward = ( function() {
